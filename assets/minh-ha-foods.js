...
define('minh-ha-foods/components/home-page/about-section/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
...
if (!runningTests) {
  require("minh-ha-foods/app")["default"].create({"name":"minh-ha-foods","version":"0.0.1+b2ca4c7d"});
}
